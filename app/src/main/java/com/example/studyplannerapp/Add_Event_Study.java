...
public class Add_Event_Study extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_event_study);
        ...
        this.event_title = (EditText) findViewById(R.id.assignment_subject) ;
        this.event_desc = (EditText) findViewById(R.id.assignment_description) ;
        ...
        save_event.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( title.length() != 0 && !time.equals("Event Time")) {
                    // DataBase
                    DBHandlerStudy dbHandlerStudy = new DBHandlerStudy(Add_Event_Study.this,"DataBaseStudyEvent",null,1) ;
                    dbHandlerStudy.addStudyEvent(new EventStudy(date,time,title,desc));
                    dbHandlerStudy.close();
                    Toast.makeText(Add_Event_Study.this, "EVENT ADDED. " , Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(Add_Event_Study.this, "ADD DETAILS PROPERLY!!", Toast.LENGTH_SHORT).show();
                }

                finish(); // This Will Stop This Activity..
                Intent intent = new Intent(Add_Event_Study.this,MainActivity.class) ;
